...
1. Monitor the **Actions** tab for the `Joke Action` workflow to complete:
   ...
   <img width="400" alt="Screenshot of the Joke Action workflow run showing a successful completion" src="https://github.com/alphagradestudios/skills-write-javascript-actions2/blob/main/.github/images/joke-action-workflow-run.png?raw=true" />
